...
namespace estadisticasStreaming.Clases
{
    internal static class Estadisticas
    {
        ...
        public static void CalcularSeriesyPuntos(out List<string[]> seriesitas, out List<int[]> puntitos)
        {
            seriesitas = new List<string[]>();
            puntitos = new List<int[]>();
            ...
            seriesitas.Add(series3);
            seriesitas.Add(series4);
            seriesitas.Add(series5);
            seriesitas.Add(series6);
            seriesitas.Add(series7);
            seriesitas.Add(series8);
            puntitos.Add(puntos);
            puntitos.Add(puntos2);
            puntitos.Add(puntos3);
            puntitos.Add(puntos4);
            puntitos.Add(puntos5);
